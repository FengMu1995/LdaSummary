...
public:
    ...
    map<int, int> _id2id; // also used only for inference ---->word id in doc transformed info word id in vocabularylists
	...
	int read_newdata(const vector<vector<string>>& new_docs, mapid2word* pid2word);
};
